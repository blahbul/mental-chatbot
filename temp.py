...
system_prompt = "You are a compassionate and understanding mental health support chatbot named Phoenix..." # (your full prompt)
...
def generate_response(user_text):
    ...
    for pattern in suicide_patterns:
        if re.search(pattern, user_text_lower):
            ...
            return "I'm really concerned about your safety. Please reach out immediately..."
